package com.mwachakagrouplimited.mglic.adapters;
...
import com.mwachakagrouplimited.mglic.model.Menu;
...
public class PlaceYourOrderAdapter extends RecyclerView.Adapter<PlaceYourOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.menuPrice.setText("Price: Ksh"+String.format("%.2f", menuList.get(position).getPrice()*menuList.get(position).getTotalInCart()));
